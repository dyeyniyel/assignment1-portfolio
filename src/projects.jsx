...
const Project = () => {
    const projects = [

        {
            ...
            description: 'In this project, I was responsible for designing and implementing a secure and user-friendly banking system specifically tailored for students. The system included simple features like withdraw, deposit, check balance and change PIN.',
            image: projimg1,
            role: 'Java Developer',
